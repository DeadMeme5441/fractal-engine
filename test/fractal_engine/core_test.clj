...
(deftest prompt-contract
  ...
  (is (clojure.string/includes? prompt/system-prompt "Representation discipline"))
  ...
  (is (clojure.string/includes? prompt/system-prompt "another leaf pass, or a child RLM"))
  ...
  (is (= 13 (:prompt/version prompt/prompt-metadata))))
